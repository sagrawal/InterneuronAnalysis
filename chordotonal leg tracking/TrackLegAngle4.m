...
function []=TrackLegAngle4(InFile,Threshold, FemurAngle)
...
%     if k > 2
%         if ((LegAngleArea(k-1, 1) - LegAngleArea(k-2, 1))+ (LegAngleArea(k-1, 1) - LegAngleArea(k, 1)))<1 && abs(LegAngleArea(k-1, 1) - LegAngleArea(k-2, 1))>3
%             LegAngleArea(k-1, 1) = mean([LegAngleArea(k-2, 1), LegAngleArea(k, 1)]);
%             LegAngleArea(k-1, 5) = mean([LegAngleArea(k-2, 5), LegAngleArea(k, 5)]);
%         end
%     end
    
%         if k > 1
%             if abs(LegAngleArea(k, 1) - LegAngleArea(k-1, 1))>100
%                 LegAngleArea(k, 1) = LegAngleArea(k-1, 1);
%                 LegAngleArea(k, 5) = LegAngleArea(k-1, 5);
%             end
%         end
