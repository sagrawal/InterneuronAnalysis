...
function []=FilterImages_All(fileTag, Hsize,GaussianSigma,usfac, NofChannels,SignalChannel,LowI,HighI)
%Get file names.
...
%     TIFF_Files(n).name
    %Run the script.
    FilterImages(TIFF_Files(n).name,Hsize,GaussianSigma,usfac, NofChannels,SignalChannel,LowI,HighI);
    close all
end
