%% 12/2/18 edited to accomodate ephys rig data, will only be used for ramp and hold data for now.
...
function []=FindStepOnset(InFile,MPW,MPD,FrameB,ThresP)
...
MinPeakHeight=2*std(AbsDiffRealAngle);
...
Outfile = strcat(NewName,'_WithStepOnset');
...
save(Outfile,'PKS','LOCS', 'frame_on', 'FrameRate', 'legangles', 'movieFiles', 'SampleRate', 'voltagedata')
